...
public partial class Creditos : ContentPage
{
    ...
    private async Task ConsultarCliente(string? cteNumIdenti, string? CodigoCobr, Mcliente cliente)
    {
        try
        {
            ...
            {
                await DisplayAlert("Sin Internet", "Está trabajando sin internet (83)", "OK");
    ...
    private void btnGrabar_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!validarDatos())
            {
                DisplayAlert("Validar datos", "Por favor verifique que toda la información ingresada esté completa y sea correcta", "OK");
